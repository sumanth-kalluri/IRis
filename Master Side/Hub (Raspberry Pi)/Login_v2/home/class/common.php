  ...
  $(document).ready(function(){
    ...
    $('input').on('click',function(){
      ...
      if(isVid===true)
        ...
        choice="ws";
      for(var i=0;i<cnt;i++){
        $("#"+i).attr('href',"vidws.php?cls="+cls+"&sub_id="+sub+"&choice="+choice+"&topic="+topics[i]);
      }
    });
      ...
      for(var i=0;i<cnt;i++){
          ...
          tb+="<tr><td><a id='"+i+"' href='vidws.php?cls="+cls+"&sub_id="+sub+"&choice="+choice+"&topic="+topics[i]+"'>"+topics[i]+"</a></td></tr>";
      }
